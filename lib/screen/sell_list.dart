...
class _SellListState extends State<SellList> {
  ...
  final ValueNotifier<double> total_Sales = ValueNotifier<double>(0);
  @override
  void initState() {
                ...
                return snapshot.data!.docs.isEmpty==true ?SingleChildScrollView(
                  ...
                  itemBuilder: (ctx, index) {
                    ...
                    return _cardWalletBalance(context,
                        ...
                        totalCrypto: snapshot.data!.docs[index]['total_investment'],
                        precent: -2.999);
        ...
        Expanded(
          ...
          child: StreamBuilder(
            stream: FirebaseFirestore.instance
                ...
                .doc(access_token.$)
                .collection('Coins').
            doc(access_token.$).collection('Sell')
            // .orderBy('createdAt')
                .snapshots(),
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              if (snapshot.hasError) {
                ...
                return ListView.builder(
                  itemCount: snapshot.data!.docs.length,
                  itemBuilder: (ctx, index) {
                    final sellItem= snapshot.data!.docs[index];
                    ...
                    //   sum = snapshot.data!.docs[i]['Amount'] + sum;
                    //   print("asdasd");
                    //       print(sum);
                    //       print("asdasd");
                    //   sums=sum;
                      ...
                      Center(
                        child: _listCryptoItem(
                          ...
                          sellItem['image'],
                            ...
                            myCrypto: sellItem['name'],
                            purchasePrice: sellItem['purchase_price'],
                            quantity: sellItem['quantity'],
                            curentPrice: sellItem['current_price'],
                            precent: double.parse(s),
                            cureentPrice: sellItem['current_price']
                        ),
                      );
                  },
                );
                      ...
                      if (snapshot.hasError) {
                        ...
                        return snapshot.data!.docs.isEmpty==true ?SingleChildScrollView(
                          ...
                          itemBuilder: (ctx, index) {
                            ...
                            // ListOFuser.add(UserCoinData(Amount: a['Amount'], id:  a['Amount'], purchase_price:  a['Amount'], name:  a['Amount'], transaction_type:  a['Amount'], quantity:  a['Amount']));
                            // totalValue.$ =snapshot.data!.docs[index]['Amount'];
                            return  Text(snapshot.data!.docs[index]['Amount'].toString(),style: TextStyle(color: Colors.orange,fontWeight: FontWeight.bold),);
